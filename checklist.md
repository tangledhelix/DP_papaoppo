...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID6111624b0410e#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=74833) and read all posts
* [x] Open `papaoppo-utf8.txt` in Guiguts
...
* [x] Click `Diacritics/Ligatures`. Scan list looking for mistakes, inconsistent usages.
...
* [x] Open `papaoppo.html` that was saved previously.
...
* [x] `make sr`
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID6111624b0410e), select SR time period, upload `papaoppo-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `papaoppo-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID6111624b0410e))
...
* [x] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID6111624b0410e)
